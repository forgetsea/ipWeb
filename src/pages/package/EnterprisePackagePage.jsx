    ...
    <div className="package-detail">
      <section className="package-summary-shell">
        <div className="package-summary-card">
          <div className="package-summary-copy">
            ...
            <h2>{enterprisePackagePage.summaryCard.title}</h2>
            <p>{enterprisePackagePage.summaryCard.description}</p>
          </div>
          <ul className="package-summary-points">
            {enterprisePackagePage.summaryCard.points.map((point) => (
      ...
      <section className="package-list-shell">
        ...
        <div className="package-plan-grid">
          {enterprisePackagePage.plans.map((plan) => (
